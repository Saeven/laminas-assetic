...
namespace Circlical\AsseticBundle\View\Helper;

use Assetic\Asset\AssetCollection;
use Assetic\Contracts\Asset\AssetInterface;
use Circlical\AsseticBundle\Exception\InvalidArgumentException;
use Circlical\AsseticBundle\Factory\ServiceFactory;
...
class Asset extends Container\AbstractStandalone
{
    ...
    {
        $type = !empty($options['type']) ? $options['type'] : 'text/javascript';
    ...
    {
        $media = !empty($options['media']) ? $options['media'] : 'screen';
        $type = !empty($options['type']) ? $options['type'] : 'text/css';
        $rel = !empty($options['rel']) ? $options['rel'] : 'stylesheet';
